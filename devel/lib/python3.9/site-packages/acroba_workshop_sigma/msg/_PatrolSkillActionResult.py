...
"""autogenerated by genpy from acroba_workshop_sigma/PatrolSkillActionResult.msg. Do not edit."""
import codecs
import sys
...
class PatrolSkillActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "acroba_workshop_sigma/PatrolSkillActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','acroba_workshop_sigma/PatrolSkillResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PatrolSkillActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = acroba_workshop_sigma.msg.PatrolSkillResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = acroba_workshop_sigma.msg.PatrolSkillResult()
