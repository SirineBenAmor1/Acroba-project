...
"""autogenerated by genpy from acroba_workshop_sigma/LeadActionResult.msg. Do not edit."""
import codecs
import sys
...
class LeadActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "acroba_workshop_sigma/LeadActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','acroba_workshop_sigma/LeadResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LeadActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = acroba_workshop_sigma.msg.LeadResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = acroba_workshop_sigma.msg.LeadResult()
