...
"""autogenerated by genpy from acroba_workshop_sigma/PatrolActionResult.msg. Do not edit."""
import codecs
import sys
...
class PatrolActionResult(genpy.Message):
  ...
  _type = "acroba_workshop_sigma/PatrolActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','acroba_workshop_sigma/PatrolResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = acroba_workshop_sigma.msg.PatrolResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = acroba_workshop_sigma.msg.PatrolResult()
