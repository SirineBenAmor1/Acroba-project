...
"""autogenerated by genpy from acroba_workshop_sigma/Move2ActionResult.msg. Do not edit."""
import codecs
import sys
...
class Move2ActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "acroba_workshop_sigma/Move2ActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','acroba_workshop_sigma/Move2Result']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(Move2ActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = acroba_workshop_sigma.msg.Move2Result()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = acroba_workshop_sigma.msg.Move2Result()
