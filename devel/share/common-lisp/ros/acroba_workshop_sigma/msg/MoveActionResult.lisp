...
(cl:defclass <MoveActionResult> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (result
    :reader result
    :initarg :result
    :type acroba_workshop_sigma-msg:MoveResult
    :initform (cl:make-instance 'acroba_workshop_sigma-msg:MoveResult)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <MoveActionResult>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MoveActionResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name acroba_workshop_sigma-msg:<MoveActionResult> is deprecated: use acroba_workshop_sigma-msg:MoveActionResult instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MoveActionResult>)))
  ...
  "acroba_workshop_sigma/MoveActionResult")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MoveActionResult)))
  "Returns string type for a message object of type 'MoveActionResult"
  "acroba_workshop_sigma/MoveActionResult")
