...
(cl:defmethod cl:initialize-instance :after ((m <PatrolFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PatrolFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name acroba_workshop_sigma-msg:<PatrolFeedback> is deprecated: use acroba_workshop_sigma-msg:PatrolFeedback instead.")))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <PatrolFeedback>))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<PatrolFeedback>)))
  ...
  "acroba_workshop_sigma/PatrolFeedback")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'PatrolFeedback)))
  "Returns string type for a message object of type 'PatrolFeedback"
  "acroba_workshop_sigma/PatrolFeedback")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<PatrolFeedback>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%# Define feedback's message~%turtlesim/Pose pose~%~%#http://wiki.ros.org/actionlib~%~%~%================================================================================~%MSG: turtlesim/Pose~%float32 x~%float32 y~%float32 theta~%~%float32 linear_velocity~%float32 angular_velocity~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'PatrolFeedback)))
  "Returns full string definition for message of type 'PatrolFeedback"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%# Define feedback's message~%turtlesim/Pose pose~%~%#http://wiki.ros.org/actionlib~%~%~%================================================================================~%MSG: turtlesim/Pose~%float32 x~%float32 y~%float32 theta~%~%float32 linear_velocity~%float32 angular_velocity~%~%"))
