...
;//! \htmlinclude LeadGoal.msg.html

(cl:defclass <LeadGoal> (roslisp-msg-protocol:ros-message)
  ((turtle_name
    :reader turtle_name
    :initarg :turtle_name
    :type cl:string
...
(cl:defclass LeadGoal (<LeadGoal>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <LeadGoal>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'LeadGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name acroba_workshop_sigma-msg:<LeadGoal> is deprecated: use acroba_workshop_sigma-msg:LeadGoal instead.")))

(cl:ensure-generic-function 'turtle_name-val :lambda-list '(m))
(cl:defmethod turtle_name-val ((m <LeadGoal>))
...
(cl:defmethod speed-val ((m <LeadGoal>))
...
(cl:defmethod distance-val ((m <LeadGoal>))
...
(cl:defmethod angle-val ((m <LeadGoal>))
...
(cl:defmethod isForward-val ((m <LeadGoal>))
  ...
  (isForward m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <LeadGoal>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <LeadGoal>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<LeadGoal>)))
  "Returns string type for a message object of type '<LeadGoal>"
  "acroba_workshop_sigma/LeadGoal")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'LeadGoal)))
  "Returns string type for a message object of type 'LeadGoal"
  "acroba_workshop_sigma/LeadGoal")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<LeadGoal>)))
  "Returns md5sum for a message object of type '<LeadGoal>"
  "5063b95f0bacef3cca474f3440a82c74")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'LeadGoal)))
  "Returns md5sum for a message object of type 'LeadGoal"
  "5063b95f0bacef3cca474f3440a82c74")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<LeadGoal>)))
  "Returns full string definition for message of type '<LeadGoal>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'LeadGoal)))
  "Returns full string definition for message of type 'LeadGoal"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%#Define goal's message~%string turtle_name~%float32 speed~%float32 distance~%float32 angle~%bool isForward~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <LeadGoal>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <LeadGoal>))
