...
let LeadResult = require('./LeadResult.js');
...
class LeadActionResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = LeadResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LeadActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = LeadResult.Resolve(msg.result)
    }
    else {
      resolved.result = new LeadResult()
    }
...
module.exports = LeadActionResult;
