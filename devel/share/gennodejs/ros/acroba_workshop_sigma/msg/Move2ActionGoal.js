...
let Move2Goal = require('./Move2Goal.js');
let std_msgs = _finder('std_msgs');
let actionlib_msgs = _finder('actionlib_msgs');

//-----------------------------------------------------------

class Move2ActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = Move2Goal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += Move2Goal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new Move2ActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = Move2Goal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new Move2Goal()
    }
...
module.exports = Move2ActionGoal;
